        ...
        <Fragment>
            ...
            <section className={StylesLayout.session}>
                ...
                <Projeto
                    ...
                    descricao={
                        `Um repositório de códigos em C# que servem de apoio para outros projetos em <span class="wavy">.NET</span>. 
                        <br/><br/>Contém múltiplos exemplos super úteis referentes à criação de uma API com .NET 7, 
